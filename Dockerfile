...
RUN curl -o plantuml.jar -L https://github.com/plantuml/plantuml/releases/download/v1.2024.4/plantuml-1.2024.4.jar && echo "3eb86968d06faaaa9d29104b14f40a9239a78c08 plantuml.jar" | sha1sum -c - && mv plantuml.jar /opt/plantuml.jar
